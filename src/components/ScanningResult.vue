<template>
    <section class="Category-section">
		<div class="container mx-auto  p-5 mt-10">
			...
			<div v-if="scanning === true">
                ...
                <div class="relative w-full md:w-2/4">
                    ...
                    <div id="barStatus" :style="{width: width + '%'}" class="shadow-md flex flex-col text-center whitespace-nowrap text-white justify-center color-bg-green-1">
                    </div>
                    </div>
                    <p class="text-sm color-white-2 text-center">Calculating your footprint...</p>
                    <h3 class="text-white md:text-2xl  text-center mt-16">Footprint estimations will be shared later and can be further specified.</h3>
                </div>
			...
			<!-- scanning result area -->
					...
					<div class="w-1/3">
						<div class="step2 step  after px-1">
							<div class="md:w-40 h-28">
								<h4 class="text-2xl md:text-5xl color-white-2 ml-2 md:ml-0 md:mb-4 font-bold">1289</h4>
								<p class="color-white-2 text-xs md:text-sm p-3 md:p-0 ">Products in your inventory</p>
							</div>
						</div>
					</div>
					<div class="w-1/3">
						<div class="step2 step  after px-1">
							<div class="md:w-40 h-28">
								<h4 class="text-2xl md:text-5xl color-white-2  ml-2 md:ml-0 md:mb-4 font-bold">23.01</h4>
								<p class="color-white-2 text-xs md:text-sm p-3 md:p-0 ">Average KG CO2e per product</p>
							</div>
						</div>
					</div>
					<div class="w-1/3">
						<div class="step2 step  after px-1">
							<div class="md:w-40 h-28">
								<h4 class="text-2xl md:text-5xl color-white-2 ml-2 md:ml-0 md:mb-4 font-bold">0.09€</h4>
								<p class="color-white-2 text-xs md:text-sm  p-3 md:p-0 ">Average ClimateNeutral <br>cost per product</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="relative flex justify-center items-center">
					<div class=" w-96 flex flex-col items-center absolute pt-12 md:pt-0">
						...
						<p class="text-white text-sm w-3/4 md:w-full text-center">Detailes can be seen and specified in the dashboard later on.</p>
					</div>
		...
		<div class="flex justify-between items-center mt-28 mb-10">
			...
			<button class="text-white md:mr-9 color-bg-green-1 py-3 px-6 rounded-2xl disabled:opacity-50" v-if="scanning === true" disabled>Get started<span class="pl-2"><i class="fas fa-angle-right"></i></span></button>
            <button @click="showPopup()" class="text-white md:mr-9 color-bg-green-1 py-3 px-6 rounded-2xl" href="#" v-else>Get started<span class="pl-2"><i class="fas fa-angle-right"></i></span></button>
		</div>
		</div>
        <!-- congreat pop up box-->
